        ...
        >
          ...
          <div className="bg-term-amber/10 border-l-4 border-term-amber p-4 rounded mb-6">
            ...
            <p className="text-term-green/80 text-xs font-mono leading-relaxed">
              ...
              <span className="text-term-red font-bold">BANNED</span> cards
              cannot be used at all.{" "}
              <span className="text-term-amber font-bold">RESTRICTED</span>{" "}
              cards are limited to 1 copy maximum (instead of the normal 3).
            </p>
          </div>
