...
export default function LoginModal({ onClose }) {
  ...
  return (
    ...
    >
      <div
        className="bg-term-gray border-2 border-term-amber rounded-lg p-8 max-w-md w-full"
      ...
      >
        ...
        <div className="space-y-4 mb-6">
          <button
            ...
            className="w-full bg-white text-black py-3 px-4 rounded font-mono font-bold hover:bg-gray-200 transition-colors flex items-center justify-center gap-3"
          >
