  ...
  if (cards.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-term-green/60 text-sm font-mono mt-2">
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
      {cards.map((card) => (
        ...
        >
          <div className="w-full h-40 sm:h-48 bg-term-gray-light rounded flex items-center justify-center flex-col border-2 border-term-amber/20">
            <p className="text-term-amber text-xs font-mono mb-2 uppercase">
              {card.type}
            </p>
            <p className="text-term-green font-mono font-bold text-center px-4">
              {card.name}
            </p>
            {card.subtitle && (
