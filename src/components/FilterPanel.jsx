  ...
  return (
    <div className="mb-6 p-4 card-container animate-slideDown">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-term-amber font-bold text-lg font-mono">FILTERS.SYS</h2>
        <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        {/* TYPE */}
        <div>
          <label className="text-term-green text-xs mb-2 block font-mono">TYPE</label>
          <select 
            value={filters.type}
        ...
        {/* FACTION */}
        <div>
          <label className="text-term-green text-xs mb-2 block font-mono">FACTION</label>
          <select 
        ...
        {/* COST */}
        <div>
          <label className="text-term-green text-xs mb-2 block font-mono">COST</label>
        ...
        {/* POWER */}
        <div>
          <label className="text-term-green text-xs mb-2 block font-mono">POWER</label>
          <div className="flex gap-2 items-center">
            <input 
              type="number"
              min="0"
        ...
        {/* RAM */}
        <div>
          <label className="text-term-green text-xs mb-2 block font-mono">RAM</label>
          <div className="flex gap-2 items-center">
            <input 
              type="number"
              min="1"
